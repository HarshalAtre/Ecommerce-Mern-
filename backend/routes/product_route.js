...
const { getAllproducts, createProduct, updateProduct, DeleteProduct, getProductDetails, createOrUpdateReview, getProductReviews, deleteReview } = require('../controller/product_controller');
